angular.module('todo.io.controllers', ['pickadate'])
...
.controller('TutorialCtrl', function($scope, $state, $ionicViewService) {
  ...
  var startApp = function() {
    ...
    window.localStorage['didTutorial'] = 1;
  };

  if(window.localStorage['didTutorial'] ==  1) {
...
//  $stateParams.todoId
// *******************
.controller('TodoCtrl', function($scope, $state, $stateParams, $ionicActionSheet, $ionicModal) {
  // 任务ID（非空编辑，空的话新建）
...
.controller('GrouplistCtrl', function($scope, $state, MenuService) {
  ...
  $scope.moveItem = function(item, fromIndex, toIndex) {
    ...
    $scope.items.splice(toIndex, 0, item);
      ...
      $scope.changeMenuDisplay = function(display) {
